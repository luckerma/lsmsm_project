...
@fig-age-per-mun shows the age distribution per municipality:
...
@fig-csp-distribution shows the socio-professional distribution of the population.
...
@fig-working-population shows the working population distribution by municipality.

XXX TODO: Remove ZZZZZ XXX

![Employees per Municipality](resources/1_3_employees_by_mun.png){#fig-employees-by-mun}

@fig-employees-by-mun shows the number of employees per municipality.
